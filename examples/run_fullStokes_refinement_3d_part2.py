...
solver = Picard(equation,line_search,max_iter=80,calc_norm=False,output_file='/gxfs_home/cau/sunip606/fenics_simulation_v.1.3.0/examples/simulation_high_resolution_corrected/part2/reference_solution')
...
solver = Newton(equation,line_search,max_iter=40,calc_norm=True,
				output_file='/gxfs_home/cau/sunip606/fenics_simulation_v.1.3.0/examples/simulation_high_resolution_corrected/part2/Newton_exact',ref_solution=solution_picard_ref)
...
equation.U = initial_stokes.U
line_search = ConstantStep()
solver = Picard(equation,line_search,max_iter=40,calc_norm=True,output_file='/gxfs_home/cau/sunip606/fenics_simulation_v.1.3.0/examples/simulation_high_resolution_corrected/part2/Picard_constant',ref_solution=solution_picard_ref)
solution_picard = solver.solve()
'''
