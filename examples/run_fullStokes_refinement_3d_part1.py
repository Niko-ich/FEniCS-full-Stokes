...
solver = Picard(equation,line_search,max_iter=80,calc_norm=False,output_file='/gxfs_home/cau/sunip606/fenics_simulation_v.1.3.0/examples/simulation_high_resolution_corrected/part1/reference_solution')
...
solver = Newton(equation,line_search,max_iter=40,calc_norm=True,output_file='/gxfs_home/cau/sunip606/fenics_simulation_v.1.3.0/examples/simulation_high_resolution_corrected/part1/Newton_armijo',ref_solution=solution_picard_ref)
...
solver = Newton(equation,line_search,max_iter=40,calc_norm=True,
				output_file='/gxfs_home/cau/sunip606/fenics_simulation_v.1.3.0/examples/simulation_high_resolution_corrected/part1/Newton_armijo_min_step',ref_solution=solution_picard_ref)
...
output_file='2d_run_final_corrected_relvel/Picard_exact',ref_solution=solution_picard_ref)
...
line_search =Armijo(min_term='functional',gamma=10**(-10))
solver = Picard(equation,line_search,max_iter=40,calc_norm=True,
output_file='2d_run_final_corrected_relvel/Picard_armijo',ref_solution=solution_picard_ref)
