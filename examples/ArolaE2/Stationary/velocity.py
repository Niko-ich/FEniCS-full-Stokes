...
def obtain_velocity(vel,relevant_coord):
	...
	counter = 0
	for k in relevant_coord:
		vel_norm[counter] = np.sqrt(vel[k][0]**2)#+vel[k][1]**2)
		counter = counter+1
	return vel_norm
...
# Reerence solutions
vel_aas1 = pd.read_csv('Reference_solutions/aas1e001_surf.txt',sep=" ",header=None)
vel_cma1 = pd.read_csv('Reference_solutions/cma1e001.txt',sep=" ",header=None)
vel_mmr1 = pd.read_csv('Reference_solutions/mmr1e001.txt',sep="\t",header=None)
vel_oga1 = pd.read_csv('Reference_solutions/oga1e001.txt',sep=" ",header=None)
vel_ssu1 = pd.read_csv('Reference_solutions/ssu1e001.txt',sep="\s+",header=None)
...
arr = np.array([df_aas1_interpolated,df_cma1_interpolated,df_mmr1_interpolated,df_oga1_interpolated,df_ssu1_interpolated])
