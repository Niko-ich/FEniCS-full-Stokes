...
df_aas1 = pd.read_csv("ISMIP_b_005/aas1b005_surf.txt",sep=" ",header=None)
...
df_oga1 = pd.read_csv("ISMIP_b_005/oga1b005.txt",sep="  ",header=None)
df_rhi1 = pd.read_csv("ISMIP_b_005/rhi1b005.txt",sep=" ",header=None)
...
velocities_Newton_exact = np.load('Newton_with_exact_without_mu0velocities.npy')
velocities_Newton_Armijo = np.load('Newton_with_Armijo_without_mu0velocities.npy')
velocities_Newton_Armijo_min_step = np.load('Newton_with_Armijo_min_step_without_mu0velocities.npy')
velocities_Picard_exact = np.load('Picard_exact_without_mu0velocities.npy')
velocities_Picard_Constant = np.load('Picard_constant_without_mu0velocities.npy')
velocities_Picard_Reference = np.load('reference_calculation_without_mu0velocities.npy')
coor = np.load('reference_calculation_without_mu0coordinates.npy')
...
df_oga1_100 = interpolate_to_new_grid(df_oga1,1,num_interpolation_points)
df_rhi1_100 = interpolate_to_new_grid(df_rhi1,2,num_interpolation_points)
...
df_aas1_100 = interpolate_to_new_grid(df_aas1,1,num_interpolation_points)

arr = np.array([df_cma1_100,df_jvj1_100,df_mmr1_100,df_rhi1_100,df_rhi3_100,df_ssu1_100,df_aas1_100,df_aas2_100,df_oga1_100])
