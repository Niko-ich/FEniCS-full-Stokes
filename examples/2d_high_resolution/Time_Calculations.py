...
Newton_Armijo_time_iteration = np.load("Newton_with_Armijocomputation_time_iteration.npy")
Newton_Armijo_min_step_time_iteration = np.load("Newton_with_Armijo_min_stepcomputation_time_iteration.npy")
Newton_exact_time_iteration = np.load("Newton_with_exactcomputation_time_iteration.npy")
...
Newton_Armijo_time_step_size = np.load("Newton_with_Armijocomputation_time_step_size.npy")
Newton_Armijo_min_step_time_step_size = np.load("Newton_with_Armijo_min_stepcomputation_time_step_size.npy")
Picard_exact_time_step_size = np.load("Picard_exactcomputation_time_step_size.npy")
Newton_exact_time_step_size = np.load("Newton_with_exactcomputation_time_step_size.npy")
