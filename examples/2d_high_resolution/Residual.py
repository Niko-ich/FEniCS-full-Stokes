...
plt.semilogy(newton_armijo_norm[0:25]/picard_norm[0],label='Newton armijo',color='#1b9e77',linewidth=width,marker='s')
plt.semilogy(newton_armijo_min_step_norm[0:25]/picard_norm[0],label='Newton armijo min step 0.5',color='#1b9e77',linewidth=width,linestyle='dashed',marker='+')
plt.semilogy(newton_exact_norm[0:25]/picard_norm[0],label='Newton exact',color='#1b9e77',linewidth=width,linestyle='dotted',marker='x')
plt.semilogy(picard_exact_norm[0:25]/picard_norm[0],label='Picard exact',color='#7570b3',linewidth=width,linestyle='dotted',marker='x',alpha=0.6)
plt.semilogy(picard_norm[0:25]/picard_norm[0],label='Picard',color='#7570b3',linewidth=width,marker='*',alpha=0.6)
plt.legend()
...
plt.plot(picard_exact_functional[0:14],label='Picard exact',color='#7570b3',linewidth=width,linestyle='dotted',marker='x',alpha=0.6)
plt.plot(picard_constant_functional[0:14],label='Picard',color='#7570b3',linewidth=width,marker='*',alpha=0.6)
plt.legend()
plt.xlabel('Iteration number',fontsize=font)
