...
newton_armijo_rel_error = np.sqrt(np.load('armijorelative_error.npy'))
newton_armijo_min_step_rel_error = np.sqrt(np.load('armijo_min_steprelative_error.npy'))
picard_exact_rel_error = np.sqrt(np.load('exact_picardrelative_error.npy'))
picard_rel_error = np.sqrt(np.load('picardrelative_error.npy'))
...
newton_armijo_rel_local_error = np.sqrt(np.load('armijorelative_local_error.npy'))
newton_armijo_min_step_rel_local_error = np.sqrt(np.load('armijo_min_steprelative_local_error.npy'))
picard_exact_rel_local_error = np.sqrt(np.load('exact_picardrelative_local_error.npy'))
picard_rel_local_error = np.sqrt(np.load('picardrelative_local_error.npy'))
