...
Domain = Arola(length_x=5000,resolution=110,dimension=2,num_more_grid=0,time_dependent=False)
...
solver = Newton(equation,line_search,max_iter=40,epsi=1e-3,calc_norm=True,output_file='ArolaE1/Stationary/Newton_exact')
...
solver = Newton(equation,line_search,max_iter=40,epsi=1e-3,calc_norm=True,output_file='ArolaE1/Stationary/Newton_armijo')
...
solver = Picard(equation,line_search,max_iter=40,epsi=1e-3,calc_norm=True,output_file='ArolaE1/Stationary/Picard')
...
equation.U = initial_stokes.U
line_search = Exact(min_term='functional',right=4.0,left=0.0,threshold=0.0)
solver = Picard(equation,line_search,max_iter=40,epsi=1e-3,calc_norm=True,output_file='ArolaE1/Stationary/Picard_exact')
