...
vel_ref_picard = np.load('reference_solutionvelocities.npy')
vel_picard = np.load('Picard_constantvelocities.npy')
vel_picard_exact = np.load('Picard_exactvelocities.npy')
vel_newton_exact = np.load('Newton_exactvelocities.npy')
vel_newton_armijo = np.load('Newton_armijovelocities.npy')
vel_newton_armijo_min_step = np.load('Newton_armijo_min_stepvelocities.npy')
coor = np.load('reference_solutioncoordinates.npy')
