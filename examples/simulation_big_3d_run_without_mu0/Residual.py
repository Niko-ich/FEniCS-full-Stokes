...
picard_exact_rel_error = np.sqrt(np.load('Picard_exactrelative_error.npy'))
...
newton_armijo_rel_error = np.sqrt(np.load('Newton_armijorelative_error.npy'))
...
picard_exact_rel_local_error = np.sqrt(np.load('Picard_exactrelative_local_error.npy'))
...
newton_armijo_rel_local_error = np.sqrt(np.load('Newton_armijorelative_local_error.npy'))
