...
solver = Newton(equation,line_search,max_iter=25,calc_norm=True,output_file='2d_low_resolution/Newton_with_Armijo')
...
solver = Newton(equation,line_search,max_iter=25,calc_norm=True,
				output_file='2d_low_resolution/Newton_with_Armijo_min_step')
...
solver = Newton(equation,line_search,max_iter=25,calc_norm=True,
				output_file='2d_low_resolution/Newton_with_exact')
...
solver = Picard(equation,line_search,max_iter=25,calc_norm=True,output_file='2d_low_resolution/Picard_constant')
...
output_file='2d_low_resolution/Picard_exact')
