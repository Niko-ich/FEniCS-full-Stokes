...
Domain = BumpyBed(k=3,resolution_x_direction=700,resolution_z_direction=20,local_refine=False)
...
solver = Picard(equation,line_search,max_iter=100,calc_norm=False,output_file='2d_high_resolution/reference_calculation')
...
solver = Newton(equation,line_search,max_iter=100,calc_norm=True,output_file='2d_high_resolution/Newton_with_Armijo',ref_solution=solution_picard_ref)
...
solver = Newton(equation,line_search,max_iter=100,calc_norm=True,
				output_file='2d_high_resolution/Newton_with_Armijo_min_step',ref_solution=solution_picard_ref)
...
solver = Newton(equation,line_search,max_iter=100,calc_norm=True,
				output_file='2d_high_resolution/Newton_with_exact',ref_solution=solution_picard_ref)
...
equation.U = initial_stokes.U
line_search = ConstantStep()
solver = Picard(equation,line_search,max_iter=100,calc_norm=True,output_file='2d_high_resolution/Picard_constant',ref_solution=solution_picard_ref)
solution_picard_ref = solver.solve()
...
equation.U = initial_stokes.U
line_search =Exact(min_term='functional',right=4.0,left=0.0)
solver = Picard(equation,line_search,max_iter=100,calc_norm=True,
output_file='2d_high_resolution/Picard_exact',ref_solution=solution_picard_ref)
solution_picard_ref = solver.solve()
...
line_search =Armijo(min_term='functional',gamma=10**(-10))
solver = Picard(equation,line_search,max_iter=100,calc_norm=True,
output_file='2d_high_resolution/Picard_armijo',ref_solution=solution_picard_ref)
solution_picard_ref = solver.solve()
